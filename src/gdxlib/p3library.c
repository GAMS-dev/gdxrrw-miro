...
/**** C code included from p3library.pas(54:1): 23 lines ****/
#if ! defined(_WIN32)
# include <dlfcn.h>
#endif
  ...
  SYSTEM_ansichar *loadmsg)
{
  ...
  dlerrmsg = NULL;
  /**** C code included from p3library.pas(131:1): 32 lines ****/
#if defined(_WIN32)
{
  UINT oldMode;
  ...
  const SYSTEM_ansichar *name)
{
  ...
  /**** C code included from p3library.pas(199:1): 12 lines ****/
#if defined(_WIN32)
  ...
  P3LIBRARY_tlibhandle handle)
{
  ...
  /**** C code included from p3library.pas(230:1): 17 lines ****/
#if defined(_WIN32)
