  ...
  SYSTEM_integer f)
{
  ...
  /**** C code included from gxfile.pas(757:1): 1 lines ****/
assert(! at_max_capacity);
...
/**** C code included from gxfile.pas(3327:1): 1 lines ****/
      assert(n >= 1);
        en = GXFILE_tintegermapping_DOT_getmapping(self->
          GXFILE_tgxfileobj_DOT_ueltable->
        ...
        d = GMSOBJ_copyptr2int(STRHASH_txstrhashlist_DOT_getobject(ValueCast(
          STRHASH_txstrhashlist,self->GXFILE_tgxfileobj_DOT_ueltable),
          en));
        /**** C code included from gxfile.pas(3336:1): 1 lines ****/
      assert((-1 == d) || (n == d));
        STRHASH_txstrhashlist_DOT_setobject(ValueCast(
          STRHASH_txstrhashlist,self->GXFILE_tgxfileobj_DOT_ueltable),
...
{
  GDLAUDIT_gdlsetauditlinelib(_P3str1("\126_GAMS_GDX Library      30.0.0 r9e57d64 ALFA Released 25Oct19 LEG x86 64bit/Linux_SMAG_"));
