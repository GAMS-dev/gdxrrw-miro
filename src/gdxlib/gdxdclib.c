    ...
    SYSTEM_ansichar *msg)
{
    ...
    typedef _P3STR_31 _arr_0XCHECK[89];
    ...
    typedef SYSTEM_integer _arr_2XCHECK[89];
    static _arr_2XCHECK dllnrarg = {3, 0, 4, 4, 1, 2, 1, 4, 1, 2, 2, 1, 0, 0, 3, 3, 0, 3, 4, 2, 3, 3, 3, 2, 3, 2, 3, 2, 2, 0, 2, 5, 2, 5, 2, 5, 1, 0, 2, 2, 2, 1, 1, 0, 1, 2, 3, 0, 0, 1, 2, 2, 3, 2, 3, 3, 4, 0, 1, 1, 1, 2, 2, 2, 0, 2, 3, 2, 2, 1, 4, 4, 1, 2, 2, 0, 0, 2, 0, 1, 0, 2, 0, 3, 3, 2, 6, 0, 2};
    typedef SYSTEM_uint8 _sub_5XCHECK;
    typedef SYSTEM_uint8 _sub_7XCHECK;
    typedef SYSTEM_integer _arr_6XCHECK[7];
    typedef _arr_6XCHECK _arr_4XCHECK[89];
