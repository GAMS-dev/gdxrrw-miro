...
/**** C code included from p3process.pas(209:1): 63 lines ****/
#if defined(_WIN32)
# include <tlhelp32.h>
...
/**** C code included from p3process.pas(463:1): 296 lines ****/
...
/**** C code included from p3process.pas(816:1): 97 lines ****/
int
  ...
  SYSTEM_integer *progrc)
{
  ...
  switch (P3PLATFORM_osfiletype()) {
    case P3PLATFORM_osfilewin: 
      /**** C code included from p3process.pas(995:1): 1 lines ****/
    ...
    case P3PLATFORM_osfileunix: 
      ...
      (*pargv)[argc] = NULL;
      /**** C code included from p3process.pas(1033:1): 1 lines ****/
  ...
  SYSTEM_integer *progrc)
{
  ...
  switch (P3PLATFORM_osfiletype()) {
    case P3PLATFORM_osfilewin: 
      ...
      /**** C code included from p3process.pas(1101:1): 1 lines ****/
      result = Win32CreateProc (NULL, (char *) cmdptr, 1, progrc);
      _P3freemem(cmdptr);
      break;
    case P3PLATFORM_osfileunix: 
      ...
      (*pargv)[argc] = NULL;
      /**** C code included from p3process.pas(1144:1): 1 lines ****/
      result =  LibcForkExec (argc, (char *const * )( *pargv), progrc);
      { register SYSTEM_int32 _stop = argc - 1;
        if ((i = 1) <=  _stop) do {
          _P3freemem((*pargv)[i]);
  ...
  SYSTEM_integer *progrc)
{
  ...
  /**** C code included from p3process.pas(1280:1): 5 lines ****/
#if defined(_WIN32)
  ...
  SYSTEM_ansichar *msg)
{
  ...
  switch (P3PLATFORM_osfiletype()) {
    case P3PLATFORM_osfilewin: 
      /**** C code included from p3process.pas(1334:1): 1 lines ****/
   result = win32ASyncCreateProc (NULL, (char *) cmdptr, newconsole, 1, procinfo);
    ...
    case P3PLATFORM_osfileunix: 
      ...
      SYSTEM_assert(_P3strcmpE(param,_P3str1("\000")),_P3str1("\036cmd string should be exhausted"));
      (*pargv)[argc] = NULL;
      /**** C code included from p3process.pas(1362:1): 1 lines ****/
  ...
  SYSTEM_ansichar *msg)
{
  ...
  /**** C code included from p3process.pas(1432:1): 101 lines ****/
{
#if defined(_WIN32)
  HANDLE h;
  DWORD p, rc, exitCode;
...
Function(SYSTEM_cardinal ) P3PROCESS_p3getpid(void)
{
  ...
  /**** C code included from p3process.pas(1608:1): 5 lines ****/
#if defined(_WIN32)
  ...
  SYSTEM_cardinal pid)
{
  ...
  result = SYSTEM_false;
  /**** C code included from p3process.pas(1630:1): 18 lines ****/
{
#if defined(_WIN32)
  HANDLE hProcess;
  DWORD p;
  ...
  SYSTEM_cardinal pid)
{
  ...
  result = SYSTEM_false;
  /**** C code included from p3process.pas(1679:1): 21 lines ****/
{
#if defined(_WIN32)
  HANDLE hProcess;
  DWORD p, rcWait;
  ...
  P3PROCESS_tkillhow how)
{
  ...
  result = SYSTEM_false;
  /**** C code included from p3process.pas(1731:1): 56 lines ****/
{
#if defined(_WIN32)
  HANDLE hProcess;
  DWORD p, rc;
...
/**** C code included from p3process.pas(1824:1): 96 lines ****/
#if defined(_WIN32)
  ...
  P3PROCESS_tkillhow how)
{
  ...
  result = SYSTEM_false;
  /**** C code included from p3process.pas(1990:1): 18 lines ****/
{
#if defined(_WIN32)
  char cmdBuf[128];
  int rc, progRC;
  ...
  P3PROCESS_tkillhow how)
{
  ...
  result = SYSTEM_false;
  /**** C code included from p3process.pas(2026:1): 35 lines ****/
{
#if defined(_WIN32)
  HANDLE hProcess;
  char cmdBuf[128];
  ...
  SYSTEM_integer *nchildrenpost)
{
  ...
  result = 1;
  /**** C code included from p3process.pas(2093:1): 1 lines ****/
  ...
  SYSTEM_ansichar *msg)
{
  ...
  (*pargv)[argc] = NULL;
  /**** C code included from p3process.pas(2147:1): 1 lines ****/
  result = libcASyncForkExec (argc, (char *const * )( *pargv), &pid);
  procinfo->pid = pid;
  _P3freemem((*pargv)[0]);
  ...
  SYSTEM_integer *progrc)
{
  ...
  /**** C code included from p3process.pas(2211:1): 31 lines ****/
#if defined(_WIN32)
  ...
  SYSTEM_ansichar *msg)
{
  ...
  /**** C code included from p3process.pas(2297:1): 5 lines ****/
#if 0
  ...
  SYSTEM_integer *progrc)
{
  ...
  /**** C code included from p3process.pas(2362:1): 1 lines ****/
...
Function(SYSTEM_P3_pansichar ) P3PROCESS_p3getcommandline(void)
{
  ...
  if (P3PLATFORM_osfilewin != P3PLATFORM_osfiletype()) { 
    ...
    /**** C code included from p3process.pas(2559:1): 5 lines ****/
#if defined(_WIN32)
...
/**** C code included from p3process.pas(2582:1): 6 lines ****/
#if ! defined(_WIN32)
...
#endif
/**** C code included from p3process.pas(2614:1): 28 lines ****/
  ...
  P3PROCESS_tctrlhandler newhandler)
{
  ...
  if (ValueCast(SYSTEM_pointer,P3PROCESS_ctrlhandler) != NULL) {
    ...
    /**** C code included from p3process.pas(2705:1): 30 lines ****/
{
#if defined(_WIN32)
...
Function(SYSTEM_integer ) P3PROCESS_p3uninstallctrlhandler(void)
{
  ...
  if (ValueCast(SYSTEM_pointer,P3PROCESS_ctrlhandler) == NULL) { 
    ...
    /**** C code included from p3process.pas(2777:1): 21 lines ****/
#if defined(_WIN32)
...
{
  /**** C code included from p3process.pas(2997:1): 5 lines ****/
#if defined(_WIN32)
...
/**** C code included from p3process.pas(3018:1): 70 lines ****/
#if defined(_WIN32)
...
Function(SYSTEM_integer ) P3PROCESS_p3getnumberofprocessors(void)
{
  ...
  /**** C code included from p3process.pas(3263:1): 12 lines ****/
#if defined(_WIN32)
...
Function(SYSTEM_integer ) P3PROCESS_p3getnumberofcores(void)
{
  ...
  result =  -1;
  /**** C code included from p3process.pas(3299:1): 60 lines ****/
#if defined(_WIN32)
{
  int coreCount, logicalCount;
  if (winProcInfo(&coreCount, &logicalCount))
  ...
  SYSTEM_integer *nlogical)
{
  ...
  *nphysical =  -1;
  *nlogical =  -1;
  /**** C code included from p3process.pas(3374:1): 7 lines ****/
#if defined(_WIN32)
{
