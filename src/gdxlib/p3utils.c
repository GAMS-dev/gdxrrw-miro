...
/**** C code included from p3utils.pas(208:1): 58 lines ****/
#if defined(_WIN32)
# include <winsock2.h>
# include <io.h>
  ...
  SYSTEM_integer mode)
{
  ...
  /**** C code included from p3utils.pas(286:1): 13 lines ****/
#if defined(_WIN32)
result = 0;
#else
{
...
/**** C code included from p3utils.pas(537:1): 26 lines ****/
  ...
  const SYSTEM_ansichar *s)
{
  ...
  if (slen == 0) { 
    ...
    tptr = NULL;
    /**** C code included from p3utils.pas(630:1): 42 lines ****/
{
    char *p;
  ...
  const SYSTEM_ansichar *dir)
{
  ...
  tptr = NULL;
  /**** C code included from p3utils.pas(752:1): 24 lines ****/
#if ! defined (_WIN32)
  {
    char *p;
  ...
  const SYSTEM_ansichar *evname)
{
  ...
  tptr = NULL;
  /**** C code included from p3utils.pas(874:1): 78 lines ****/
{
  char *p;
  size_t evLen;
  ...
  const SYSTEM_ansichar *val)
{
  ...
  /**** C code included from p3utils.pas(976:1): 5 lines ****/
#if defined(_WIN32)
  ...
  const SYSTEM_ansichar *name)
{
  ...
  nameptr = P3PRIVATE_strtostrbuf(name,namebuf);
  /**** C code included from p3utils.pas(1005:1): 5 lines ****/
#if defined(_WIN32)
  ...
  const SYSTEM_ansichar *name)
{
  ...
  nameptr = P3PRIVATE_strtostrbuf(name,namebuf);
  /**** C code included from p3utils.pas(1034:1): 5 lines ****/
#if defined(_WIN32)
  ...
  SYSTEM_P3_pansichar val)
{
  ...
  nameptr = P3PRIVATE_strtostrbuf(name,namebuf);
  /**** C code included from p3utils.pas(1062:1): 5 lines ****/
#if defined(_WIN32)
  ...
  SYSTEM_cardinal bufsiz)
{
  ...
  nameptr = P3PRIVATE_strtostrbuf(name,namebuf);
  /**** C code included from p3utils.pas(1087:1): 21 lines ****/
#if defined(_WIN32)
  ...
  const SYSTEM_ansichar *s)
{
  ...
  /**** C code included from p3utils.pas(1127:1): 5 lines ****/
#if defined(_WIN32)
...
{
  /**** C code included from p3utils.pas(1151:1): 5 lines ****/
#if defined(_WIN32)
...
/**** C code included from p3utils.pas(1162:1): 62 lines ****/
#if defined(_WIN32)
  ...
  P3UTILS_tp3filehandle h)
{
  ...
  /**** C code included from p3utils.pas(1237:1): 5 lines ****/
#if defined(_WIN32)
  ...
  P3UTILS_tp3filehandle *h)
{
  ...
  /**** C code included from p3utils.pas(1354:1): 81 lines ****/
#if defined(_WIN32)
{
  DWORD lowMode;
  HANDLE hFile;
  ...
  P3UTILS_tp3filehandle *h)
{
  ...
  /**** C code included from p3utils.pas(1468:1): 28 lines ****/
  ...
  SYSTEM_longword *numread)
{
  ...
  /**** C code included from p3utils.pas(1528:1): 31 lines ****/
#if defined(_WIN32)
{
  ...
  SYSTEM_longword *numwritten)
{
  ...
  /**** C code included from p3utils.pas(1591:1): 31 lines ****/
#if defined(_WIN32)
{
  ...
  SYSTEM_int64 *filesize)
{
  ...
  *filesize =  -1;
  /**** C code included from p3utils.pas(1668:1): 49 lines ****/
if ( ! P3UTILS_isvalidhandle (h)) {
  return EBADF;
}
#if defined(_WIN32)
  ...
  SYSTEM_longword whence)
{
  ...
  /**** C code included from p3utils.pas(1773:1): 75 lines ****/
if ( ! P3UTILS_isvalidhandle (h)) {
  return EBADF;
}
#if defined(_WIN32)
  ...
  SYSTEM_int64 *filepointer)
{
  ...
  /**** C code included from p3utils.pas(1885:1): 56 lines ****/
if ( ! P3UTILS_isvalidhandle (h)) {
  return EBADF;
}
#if defined(_WIN32)
...
Function(SYSTEM_int64 ) P3UTILS_p3allocmemsize64(void)
{
  ...
  /**** C code included from p3utils.pas(1956:1): 1 lines ****/
  ...
  SYSTEM_int64 size)
{
  ...
  if (size <= 0) 
    return result;
  /**** C code included from p3utils.pas(1977:1): 13 lines ****/
  if (8 == sizeof(result)) {
...
{
  /**** C code included from p3utils.pas(2022:1): 11 lines ****/
  if (size <= 0)
    return;
  if (8 == sizeof(p)) {
...
Procedure P3UTILS_p3freemem64(
  ...
  SYSTEM_int64 size)
{
  /**** C code included from p3utils.pas(2053:1): 11 lines ****/
  if (8 == sizeof(p)) {
    _P3_free64 (*p, size);
  }
  else {
  ...
  SYSTEM_int64 size)
{
  ...
  /**** C code included from p3utils.pas(2085:1): 11 lines ****/
  if (8 == sizeof( *p )) {
    _P3_new64 (p, size);
  }
  else {
...
Procedure P3UTILS_p3move64(
  ...
  SYSTEM_int64 sz)
{
  /**** C code included from p3utils.pas(2115:1): 9 lines ****/
  if (8 == sizeof( source )) {
  ...
  SYSTEM_int64 size)
{
  ...
  /**** C code included from p3utils.pas(2151:1): 11 lines ****/
  if (8 == sizeof(p)) {
  ...
  SYSTEM_ansichar *msg)
{
  ...
  /**** C code included from p3utils.pas(2270:1): 115 lines ****/
#if defined(_WIN32)
  ...
  SYSTEM_ansichar *mac)
{
  ...
  result = SYSTEM_false;
  /**** C code included from p3utils.pas(2402:1): 167 lines ****/
#if defined(__linux__)
{
   struct ifreq ifr;
   struct ifconf ifc;
  ...
  SYSTEM_uint8 _len_ret)
{
  ...
  /**** C code included from p3utils.pas(2625:1): 27 lines ****/
#if defined(_WIN32)
   {
     char compName[256];
     DWORD n;
...
{
  _P3strcpy(result,_len_ret,_P3str1("\007unknown"));
  /**** C code included from p3utils.pas(2675:1): 47 lines ****/
#if defined(_WIN32)
   {
     char userName[256];
     DWORD n;
  ...
  const SYSTEM_ansichar *_ftmp2)
{
  ...
  result = SYSTEM_false;
  /**** C code included from p3utils.pas(2764:1): 38 lines ****/
#if defined(_WIN32)
{
   HWND receiver;
   COPYDATASTRUCT cds;
  ...
  SYSTEM_uint8 _len_ret)
{
  ...
  /**** C code included from p3utils.pas(2811:1): 10 lines ****/
{
  char *s;
  ...
  const SYSTEM_ansichar *s)
{
  if (_P3char('\001') == s[0] && _P3char('C') == s[1]) 
    return;
  /**** C code included from p3utils.pas(2834:1): 10 lines ****/
{
  char buf[32];
  int n = sizeof(buf)-1;
...
/**** C code included from p3utils.pas(2852:1): 1 lines ****/
#include "p3Custom2.h"
  ...
  SYSTEM_ansichar *msg)
{
  ...
  /**** C code included from p3utils.pas(2865:1): 1 lines ****/
  ...
  SYSTEM_ansichar *msg)
{
  ...
  _P3strclr(libname);
  _P3strcpy(msg,255,_P3str1("\027P3: not yet implemented"));
  /**** C code included from p3utils.pas(2907:1): 1 lines ****/
...
Function(SYSTEM_integer ) P3UTILS_p3someioresult(void)
{
  ...
  /**** C code included from p3utils.pas(2945:1): 1 lines ****/
result = EIO;
  return result;
}  /* p3someioresult */
  ...
  SYSTEM_int64 *vss)
{
  ...
  *rss = 0;
  *vss = 0;
  /**** C code included from p3utils.pas(3020:1): 68 lines ****/
#if defined(_WIN32)
{
