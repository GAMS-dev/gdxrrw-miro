...
typedef SYSTEM_byte EXCEPTIONS_texceptions; /* Anonymous */ enum{EXCEPTIONS_cnoexception,EXCEPTIONS_cexception,
  ...
  EXCEPTIONS_cconverterror,EXCEPTIONS_cinvalidcast,
  EXCEPTIONS_cinterror,EXCEPTIONS_crangeerror,
  EXCEPTIONS_cassertionfailed,EXCEPTIONS_cheapexception,
  EXCEPTIONS_coutofmemory,EXCEPTIONS_cabstracterror};
