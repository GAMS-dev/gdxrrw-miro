...
/**** C code included from math_p3.pas(104:1): 33 lines ****/
#if   defined(AIX)
# include <float.h>
# include <fpxcp.h>
# include <fptrap.h>
  ...
  SYSTEM_double x)
{
  ...
  /**** C code included from math_p3.pas(146:1): 1 lines ****/
  result = acos(x);
  return result;
}  /* arccos */
  ...
  SYSTEM_double x)
{
  ...
  /**** C code included from math_p3.pas(157:1): 1 lines ****/
  result = asin(x);
  return result;
}  /* arcsin */
  ...
  SYSTEM_double x)
{
  ...
  /**** C code included from math_p3.pas(190:1): 1 lines ****/
  result = tan(x);
  return result;
}  /* tan */
  ...
  SYSTEM_double x)
{
  ...
  /**** C code included from math_p3.pas(333:1): 1 lines ****/
  result = log1p(x);
  return result;
}  /* lnxp1 */
  ...
  SYSTEM_uint8 _len_ret)
{
  ...
  /**** C code included from math_p3.pas(354:1): 85 lines ****/
#if defined(_WIN32)
{
  unsigned int cw;
...
{
  _P3SET_copy(result,_len_ret,_P3empty_set);
  /**** C code included from math_p3.pas(469:1): 177 lines ****/
...
{
  /**** C code included from math_p3.pas(680:1): 16 lines ****/
#if defined(_WIN32)
  (void) _clearfp();
#elif defined(AIX)
