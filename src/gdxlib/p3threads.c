...
/**** C code included from p3threads.pas(329:1): 9 lines ****/
#if defined(_WIN32)
...
static SYSTEM_int64 P3THREADS_nicksperyear;
/**** C code included from p3threads.pas(351:1): 77 lines ****/
  ...
  SYSTEM_int64 *tv_nsec)
{
  *tv_sec =  -1;
  *tv_nsec =  -1;
  /**** C code included from p3threads.pas(437:1): 9 lines ****/
#if ! defined(_WIN32)
{
  struct timespec ts;
...
/**** C code included from p3threads.pas(474:1): 34 lines ****/
#if defined(_WIN32)
  ...
  P3THREADS_tp3thread thread)
{
  ...
  /**** C code included from p3threads.pas(519:1): 18 lines ****/
#if ! defined(_WIN32)
...
# endif
  ...
  /**** C code included from p3threads.pas(550:1): 5 lines ****/
#if defined(_WIN32)
  ExitThread(result);
#else
  ...
  P3THREADS_tp3thread self)
{
  ...
  /**** C code included from p3threads.pas(566:1): 20 lines ****/
#if defined(_WIN32)
#  if defined(_WIN64)
  ...
  SYSTEM_boolean createsuspended)
{
  ...
  nbytes = 0;
  /**** C code included from p3threads.pas(620:1): 7 lines ****/
#if ! defined(_WIN32)
# if 1 == __P3_HAVE_SEM_INIT__
  nbytes = sizeof(sem_t);
# else
...
# endif
  ...
  nbytes = 0;
  /**** C code included from p3threads.pas(640:1): 3 lines ****/
#if ! defined(_WIN32)
  ...
  /**** C code included from p3threads.pas(683:1): 73 lines ****/
#if defined(_WIN32)
{
  HANDLE h;
  DWORD tid;
  ...
  P3THREADS_tp3thread self)
{
  ...
  /**** C code included from p3threads.pas(785:1): 31 lines ****/
#if defined(_WIN32)
#  if defined(_WIN64)
...
Procedure P3THREADS_tp3thread_DOT_resume(
  P3THREADS_tp3thread self)
{
  /**** C code included from p3threads.pas(869:1): 39 lines ****/
#if defined(_WIN32)
{
  int suspendCount;
  HANDLE h;
  ...
  P3THREADS_tp3thread self)
{
  ...
  /**** C code included from p3threads.pas(946:1): 45 lines ****/
#if defined(_WIN32)
{
  int waitResult;
  HANDLE h;
  ...
  P3THREADS_tp3mutex self)
{
  ...
  ValueCast(P3THREADS_tp3mutex,SYSTEM_tobject_DOT_create(ValueCast(
    SYSTEM_tobject,self)));
  nbytes = 0;
  /**** C code included from p3threads.pas(1006:1): 5 lines ****/
#if defined(_WIN32)
  ...
  /**** C code included from p3threads.pas(1025:1): 15 lines ****/
#if defined(_WIN32)
{
...
Destructor(P3THREADS_tp3mutex ) P3THREADS_tp3mutex_DOT_destroy(
  P3THREADS_tp3mutex self)
{
  /**** C code included from p3threads.pas(1050:1): 22 lines ****/
#if defined(_WIN32)
{
  CRITICAL_SECTION *pCS = (CRITICAL_SECTION *) &(FMUX(self));
...
Procedure P3THREADS_tp3mutex_DOT_lock(
  P3THREADS_tp3mutex self)
{
  /**** C code included from p3threads.pas(1083:1): 17 lines ****/
#if defined(_WIN32)
{
  CRITICAL_SECTION *pCS = (CRITICAL_SECTION *) &(FMUX(self));
  ...
  P3THREADS_tp3mutex self)
{
  ...
  /**** C code included from p3threads.pas(1116:1): 22 lines ****/
#if defined(_WIN32)
{
  CRITICAL_SECTION *pCS = (CRITICAL_SECTION *) &(FMUX(self));
  BOOL gotIt;
  ...
  P3THREADS_tp3mutex self)
{
  ...
  /**** C code included from p3threads.pas(1152:1): 16 lines ****/
#if defined(_WIN32)
{
  CRITICAL_SECTION *pCS = (CRITICAL_SECTION *) &(FMUX(self));
  ...
  P3THREADS_tp3condvar self)
{
  ...
  ValueCast(P3THREADS_tp3condvar,SYSTEM_tobject_DOT_create(ValueCast(
    SYSTEM_tobject,self)));
  nbytes = 0;
  /**** C code included from p3threads.pas(1226:1): 5 lines ****/
#if defined(_WIN32)
  ...
  /**** C code included from p3threads.pas(1241:1): 15 lines ****/
#if defined(_WIN32)
{
...
Destructor(P3THREADS_tp3condvar ) P3THREADS_tp3condvar_DOT_destroy(
  P3THREADS_tp3condvar self)
{
  /**** C code included from p3threads.pas(1269:1): 16 lines ****/
#if defined(_WIN32)
  ...
  P3THREADS_tp3condvar self)
{
  ...
  /**** C code included from p3threads.pas(1301:1): 16 lines ****/
  ...
  P3THREADS_tp3condvar self)
{
  ...
  /**** C code included from p3threads.pas(1332:1): 15 lines ****/
#if defined(_WIN32)
{
  CONDITION_VARIABLE *pCV = (CONDITION_VARIABLE *) &(FCV(self));
  ...
  P3THREADS_tp3mutex mx)
{
  ...
  /**** C code included from p3threads.pas(1366:1): 17 lines ****/
#if defined(_WIN32)
{
  CONDITION_VARIABLE *pCV = (CONDITION_VARIABLE *) &(FCV(self));
  ...
  P3THREADS_tcvtime abstime)
{
  ...
  result = SYSTEM_true;
  /**** C code included from p3threads.pas(1414:1): 40 lines ****/
#if defined(_WIN32)
{
...
Function(P3THREADS_tcvtime ) P3THREADS_nowcv(void)
{
  ...
  result = 0;
  /**** C code included from p3threads.pas(1786:1): 19 lines ****/
#if defined(_WIN32)
{
  cvTime_t cvt;
...
void _Init_Module_p3threads(void)
{
  ...
  P3THREADS_nicksperyear = P3THREADS_nicksperday * 365;
