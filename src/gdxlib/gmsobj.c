  ...
  GMSOBJ_txlist self)
{
  ...
  if (i64 < 2147483647) { 
    ...
    if (1.05 * self->GMSOBJ_txlist_DOT_fcapacity < 2147483647) { 
      GMSOBJ_txlist_DOT_setcapacity(self,2147483645);
    } else 
  ...
  GMSOBJ_txcustomstringlist self)
{
  ...
  if (i64 < 2147483647) { 
    ...
    if (1.05 * self->GMSOBJ_txcustomstringlist_DOT_fcapacity < 2147483647) { 
      GMSOBJ_txcustomstringlist_DOT_setcapacity(self,2147483645);
    } else 
