  ...
  PALDOORG_tpalobject self)
{
  ...
  PALDOORG_blankfill(self->PALDOORG_tpalobject_DOT_gdlrelcpr,70,_P3str1("\075Copyright (C) 1987-2019 GAMS Development. All rights reserved"));
  PALDOORG_blankfill(self->PALDOORG_tpalobject_DOT_gdlreldat,21,_P3str1("\025ALFA Released 25Oct19"));
  PALDOORG_blankfill(self->PALDOORG_tpalobject_DOT_gdllicdat,12,_P3str1("\014Oct 25, 2019"));
  _P3strcpy(self->PALDOORG_tpalobject_DOT_gdlrelmaj,2,_P3str1("\00230"));
  _P3strcpy(self->PALDOORG_tpalobject_DOT_gdlrelmin,1,_P3str1("\0010"));
  _P3strcpy(self->PALDOORG_tpalobject_DOT_gdlrelgold,1,_P3str1("\0010"));
  self->PALDOORG_tpalobject_DOT_gdllicjul = 43762;
  ...
  _P3strcpy(self->PALDOORG_tpalobject_DOT_gdlrevision,12,_P3str1("\010r9e57d64"));
  ...
  SYSTEM_integer *rc)
{
  ...
  SYSTEM_integer i, j, off, len6, bomoffset;
  ...
  *rc = SYSTEM_ioresult();
  ...
  for (i = 1;i <= (SYSTEM_int32)PALDOORG_maxlicense;++i) {
    ...
    if (i <= len6 && self->PALDOORG_tpalobject_DOT_license6[i] == _P3char('_')) 
...
Procedure PALDOORG_tpalobject_DOT_makedemolicense(
  PALDOORG_tpalobject self)
{
  _P3strcpy(self->PALDOORG_tpalobject_DOT_license1,65,_P3str1("\101GAMS Development Corporation, USA              G871201/0000CA-ANY"));
  _P3strcpy(self->PALDOORG_tpalobject_DOT_license2,65,_P3str1("\101Free Demo, +1 202-342-0180, support@gams.com, www.gams.com       "));
  {
    SYSTEM_shortstring _t1;

    _P3strcat(self->PALDOORG_tpalobject_DOT_license3,65,
      SYSUTILS_P3_inttostr(_t1,255,SYSTEM_round(10000000 + 12 * 
  ...
  if (code1 == code2 && self->PALDOORG_tpalobject_DOT_licenselevel == 4) {
      ...
      return result;
    {
      ...
      _P3strcpy(nodelocktype,255,SYSUTILS_P3_trim(_t1,255,
        SYSTEM_copy(_t2,255,self->PALDOORG_tpalobject_DOT_license2,1,
        i)));
    }
    if (SYSUTILS_P3_sametext(_P3str1("\004aws@"),nodelocktype)) {
      ...
      if (SYSUTILS_P3_sametext(_P3str1("\004mac@"),nodelocktype)) {
        ...
        if (!P3UTILS_p3getfirstmacaddress(acthostid)) {
          _Iplus_bgn();
          _P3write_s0(_P3str1("\035*** MAC address not available"));
          _P3writeln();
          _Iplus_end();
          return result;
        } 
        if (!SYSUTILS_P3_sametext(hostid,acthostid)) {
          _Iplus_bgn();
          _P3write_s0(_P3str1("\040*** MAC address does not match: "));
          _P3write_s0(hostid);
          _P3write_s0(_P3str1("\017 (expected) <> "));
          _P3write_s0(acthostid);
          _P3write_s0(_P3str1("\011 (actual)"));
          _P3writeln();
          _Iplus_end();
          return result;
        } 
      ...
      if (self->PALDOORG_tpalobject_DOT_isglobal == 1) {
        if (self->PALDOORG_tpalobject_DOT_rowcnt > 10) {
          ...
          }
          {
            ...
            PALDOORG_tpalobject_DOT_msgadd(self,_P3strcat(_t2,255,_P3str1("\045***   Maximum allowed              : "),
              SYSUTILS_P3_inttostr(_t1,255,
              PALDOORG_demoglobalmaxrow)));
          }
        } 
        ...
        if (self->PALDOORG_tpalobject_DOT_rowcnt > 300) {
          ...
          }
          {
            ...
            PALDOORG_tpalobject_DOT_msgadd(self,_P3strcat(_t2,255,_P3str1("\045***   Maximum allowed              : "),
              SYSUTILS_P3_inttostr(_t1,255,PALDOORG_demomaxrow)));
          }
        } 
        if (self->PALDOORG_tpalobject_DOT_colcnt > 300) {
          ...
          }
          {
            ...
            PALDOORG_tpalobject_DOT_msgadd(self,_P3strcat(_t2,255,_P3str1("\045***   Maximum allowed              : "),
              SYSUTILS_P3_inttostr(_t1,255,PALDOORG_demomaxcol)));
          }
        } 
        if (self->PALDOORG_tpalobject_DOT_nzcnt > 2000) {
          ...
          }
          {
            ...
            PALDOORG_tpalobject_DOT_msgadd(self,_P3strcat(_t2,255,_P3str1("\045***   Maximum allowed              : "),
              SYSUTILS_P3_inttostr(_t1,255,PALDOORG_demomaxnz)));
          }
        } 
        if (self->PALDOORG_tpalobject_DOT_nlnzcnt > 1000) {
          ...
          }
          {
            ...
            PALDOORG_tpalobject_DOT_msgadd(self,_P3strcat(_t2,255,_P3str1("\045***   Maximum allowed              : "),
              SYSUTILS_P3_inttostr(_t1,255,PALDOORG_demomaxnlnz)));
          }
        } 
        if (self->PALDOORG_tpalobject_DOT_disccnt > 50) {
          ...
          }
          {
            ...
            PALDOORG_tpalobject_DOT_msgadd(self,_P3strcat(_t2,255,_P3str1("\045***   Maximum allowed              : "),
              SYSUTILS_P3_inttostr(_t1,255,PALDOORG_demomaxdisc)));
          }
        } 
      }
    } 
...
{
  {
    ...
    _P3strcat(result,_len_ret,SYSUTILS_P3_inttostr(_t1,255,
  ...
  SYSTEM_integer *daysleft)
{
  ...
  if ((SYSUTILS_P3_sametext(_P3str1("\006soplex"),sname) || 
    ...
    SYSUTILS_P3_sametext(_P3str1("\010odhcplex"),sname) || 
