...
cnstdef {GMSGLOBX_maxsolvernames = 151};
...
Function(SYSTEM_integer ) GMSGLOBX_componentslookup(
  const SYSTEM_ansichar *_ftmp1);
cnstdef {GMSGLOBX_maxclipcodes = 61};
...
Function(SYSTEM_integer ) GMSGLOBX_modeltypesxlookup(
  const SYSTEM_ansichar *_ftmp1);
cnstdef {GMSGLOBX_maxcomponentsolvermap = 168};

Function(SYSTEM_integer ) GMSGLOBX_componentsolvermapmap(
  SYSTEM_integer i,
  SYSTEM_integer j);
cnstdef {GMSGLOBX_maxclipcomponentmap = 50};

Function(SYSTEM_integer ) GMSGLOBX_clipcomponentmapmap(
  SYSTEM_integer i,
  SYSTEM_integer j);
cnstdef {GMSGLOBX_maxsolverplatformmap = 729};

Function(SYSTEM_integer ) GMSGLOBX_solverplatformmapmap(
  SYSTEM_integer i,
  SYSTEM_integer j);
cnstdef {GMSGLOBX_maxsolvertypeplatformmap = 2419};
