...
_arr_1P3PLATFORM P3PLATFORM_osplatformtext = {{3,'D','O','S'}, {5,'W','i','n','9','5'}, {5,'W','i','n','N','T'}, {8,'W','i','n','6','4','E','M','T'}, {3,'A','I','X'}, {5,'H','P','-','U','X'}, {6,'I','R','I','X','6','4'}, {5,'L','i','n','u','x'}, {13,'S','u','n','O','S','-','s','p','a','r','c','3','2'}, {4,'O','S','F','1'}, {10,'D','a','r','w','i','n','-','p','p','c'}, {10,'L','i','n','u','x','8','6','_','6','4'}, {11,'S','u','n','O','S','-','i','8','6','p','c'}, {13,'S','u','n','O','S','-','s','p','a','r','c','6','4'}, {11,'D','a','r','w','i','n','-','i','3','8','6'}, {10,'D','a','r','w','i','n','-','x','6','4'}, {12,'D','a','r','w','i','n','-','a','r','m','6','4'}, {8,'B','l','u','e','G','e','n','e'}, {7,'M','i','s','s','i','n','g'}};
_arr_2P3PLATFORM P3PLATFORM_osdllextension = {{4,'.','d','l','l'}, {4,'.','d','l','l'}, {4,'.','d','l','l'}, {4,'.','d','l','l'}, {3,'.','s','o'}, {3,'.','s','l'}, {3,'.','s','o'}, {3,'.','s','o'}, {3,'.','s','o'}, {3,'.','s','o'}, {6,'.','d','y','l','i','b'}, {3,'.','s','o'}, {3,'.','s','o'}, {3,'.','s','o'}, {6,'.','d','y','l','i','b'}, {6,'.','d','y','l','i','b'}, {6,'.','d','y','l','i','b'}, {3,'.','s','o'}, {4,'.','X','X','X'}};
_arr_3P3PLATFORM P3PLATFORM_osdllprefix = {{0}, {0}, {0}, {0}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}, {3,'l','i','b'}};
...
void _Init_Module_p3platform(void)
{
  ...
  /**** C code included from p3platform.pas(269:1): 17 lines ****/
...
# error "P3<OSTYPE> not defined for any recognized OS type"
  ...
  /**** C code included from p3platform.pas(291:1): 62 lines ****/
...
#elif defined(P3UNIX)
{
  ...
  if ((err = uname(&uts)) < 0)
    ...
    if      (0==strcmp(uts.sysname,"AIX"))
      ...
      if (0==strcmp(uts.machine,"arm64"))
        localosplatform  = P3PLATFORM_osdarwin_arm64;
      else
