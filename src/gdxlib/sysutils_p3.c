  ...
  SYSTEM_cardinal sz)
{
  ...
  _P3getmem(result,sz);
  /**** C code included from sysutils_p3.pas(491:1): 1 lines ****/
  ...
  const SYSTEM_ansichar *filename)
{
  ...
  /**** C code included from sysutils_p3.pas(778:1): 32 lines ****/
#if defined(_WIN32)
{
  HANDLE          handle;
  ...
  const SYSTEM_ansichar *filename)
{
  ...
  /**** C code included from sysutils_p3.pas(864:1): 12 lines ****/
char buf[256];
unsigned char len;
/* */
len = filename[0];
  ...
  const SYSTEM_ansichar *directory)
{
  ...
  /**** C code included from sysutils_p3.pas(891:1): 25 lines ****/
char dirBuf[256];
unsigned char len;
/* */
len = directory[0];
  ...
  SYSUTILS_P3_tsearchrec *f)
{
  ...
  /**** C code included from sysutils_p3.pas(1027:1): 100 lines ****/
#if defined(_WIN32)
{
  int len;
  ...
  SYSUTILS_P3_tsearchrec *f)
{
  ...
  /**** C code included from sysutils_p3.pas(1186:1): 39 lines ****/
#if defined(_WIN32)
{
  char pathbuf[256];
  int len;
  ...
  SYSUTILS_P3_tsearchrec *f)
{
  ...
  /**** C code included from sysutils_p3.pas(1241:1): 10 lines ****/
#if defined(_WIN32)
  if (FindNextFile((HANDLE)f->findhandle, (PWIN32_FIND_DATA) &(f->finddata))) {
    result = SYSUTILS_P3_findmatchingfile(f);
  }
...
Procedure SYSUTILS_P3_findclose(
  SYSUTILS_P3_tsearchrec *f)
{
  /**** C code included from sysutils_p3.pas(1277:1): 13 lines ****/
#if defined(_WIN32)
  ...
  const SYSTEM_ansichar *filename)
{
  ...
  /**** C code included from sysutils_p3.pas(1314:1): 5 lines ****/
#if defined(_WIN32)
  ...
  const SYSTEM_ansichar *newname)
{
  ...
  /**** C code included from sysutils_p3.pas(1346:1): 5 lines ****/
#if defined(_WIN32)
...
Function(SYSTEM_ansichar *) SYSUTILS_P3_extractshortpathname(
  ...
  const SYSTEM_ansichar *filename)
{
  /**** C code included from sysutils_p3.pas(1442:1): 17 lines ****/
#if defined(_WIN32)
  {
  ...
  SYSTEM_integer filedate)
{
  ...
  /**** C code included from sysutils_p3.pas(1484:1): 11 lines ****/
{
#if ! defined(_WIN32)
  struct tm ut;
  time_t tim;
  ...
  SYSTEM_P3_tdatetime datetime)
{
  ...
  if (P3PLATFORM_osfiletype() == P3PLATFORM_osfilewin) { 
    ...
    if (year < 1970 || year > 2038) { 
      ...
      SYSUTILS_P3_decodetime(datetime,&hour,&minu,&sec,&msec);
      /**** C code included from sysutils_p3.pas(1552:1): 17 lines ****/
#if defined(_WIN32)
      result = -1;
#else
{
  ...
  SYSTEM_uint8 _len_ret)
{
  ...
  isok = SYSTEM_true;
  _P3strclr(emsg);
  /**** C code included from sysutils_p3.pas(1629:1): 57 lines ****/
{
  ...
  const SYSTEM_ansichar *dir)
{
  ...
  /**** C code included from sysutils_p3.pas(1719:1): 5 lines ****/
#if defined(_WIN32)
  ...
  const SYSTEM_ansichar *dir)
{
  ...
  p = ValueCast(SYSTEM_P3_pansichar,&_dirname[0]);
  SYSUTILS_P3_strpcopy(p,dir);
  /**** C code included from sysutils_p3.pas(1752:1): 5 lines ****/
#if defined(_WIN32)
  ...
  SYSTEM_P3_pansichar str)
{
  ...
  /**** C code included from sysutils_p3.pas(1766:1): 1 lines ****/
  ...
  const SYSTEM_ansichar *src)
{
  ...
  /**** C code included from sysutils_p3.pas(1786:1): 1 lines ****/
  dest[len] = '\0';
  result = dest;
  return result;
}  /* strpcopy */
...
Function(SYSTEM_P3_tdatetime ) SYSUTILS_P3_date(void)
{
  ...
  /**** C code included from sysutils_p3.pas(2090:1): 19 lines ****/
int rc;
#if defined(_WIN32)
SYSTEMTIME st;
GetLocalTime(&st);
...
Function(SYSTEM_P3_tdatetime ) SYSUTILS_P3_time(void)
{
  ...
  /**** C code included from sysutils_p3.pas(2124:1): 21 lines ****/
int rc;
#if defined(_WIN32)
SYSTEMTIME st;
GetLocalTime(&st);
...
Function(SYSTEM_P3_tdatetime ) SYSUTILS_P3_now(void)
{
  ...
  /**** C code included from sysutils_p3.pas(2159:1): 30 lines ****/
int rc;
double dnow, tnow;
#if defined(_WIN32)
SYSTEMTIME st;
...
{
  /**** C code included from sysutils_p3.pas(2204:1): 15 lines ****/
{
  int i;
...
{
  /**** C code included from sysutils_p3.pas(2262:1): 14 lines ****/
#if defined(_WIN32)
  Sleep(milliseconds);
#else
{
...
{
  /**** C code included from sysutils_p3.pas(2301:1): 40 lines ****/
{
  char buf[256];
  char *s;
  int len;
